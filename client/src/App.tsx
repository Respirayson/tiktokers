...
function App() {
	...
	const [linearPlot, setLinearPlot] = useState<string | null>(null);
	...
	useEffect(() => {
		...
		socket.on("training_complete", (data) => {
			...
			if (problem === "linear_regression") {
				setLinearPlot(data.linear_plot);
			} else {
			...
			<div className="pl-[16rem]">
				...
				{selectedButton === "Results" && (
					<div className="w-full flex flex-col items-center justify-center h-screen">
						...
						{problem === "linear_regression" && linearPlot && (
						...
						{problem !== "linear_regression" && confusionMatrix && (
							<div className="w-full mt-4">
								<img
